...
background-position: 50% 50%;" >
    ...
    <div class="container">
        ...
        session_start();
           ...
           $formattedPhone = $_SESSION['formatted_phone'];?>
    <p class="">we sent you a verification code by message to </br><?php echo $formattedPhone ?>. You have 6 attempts.</p>
    <form action="" class="" style="margin-top: 40px;">
        <div class="inner-form" style="width: 80%;margin: auto;">
            ...
            <input type="number" class="form-control" placeholder="Code" style="border-radius: 3px;height: 50px;" name="" id="number">
