...
<head>
    <title>Checkout - Beno Maternity</title>
    <meta charset="UTF-8" />
    ...
    <link rel="icon" type="image/png"
        href="images/favicon-32x32_8a73ddf9-696e-40e9-b706-40903c490131.png?crop=center&height=32&v=1703071897&width=32">
...
<body class="">
        ...
        <header role="banner"
            ...
            <div class="LoadingShellHeaderContent">
                <div class="LoadingHeader LoadingHeader-alignmentStart">
                    <h1 class="LoadingHeaderHeading"><img alt="Beno Maternity"
                            src="https://cdn.shopify.com/s/files/1/0840/7954/2579/files/d_x320.png?v=1697369889"
                ...
                <div class="row">
                    <div class="col-12 col-sm-12 col-lg-7 box1 col-paddingS h-auto" style="">
                        <div class="form-content">
                            ...
                            <div class="btns mt-4">
                                <a><img
                                        src="images/checkout/shop-pay-monotone-logo-examples-421ebd1c1cba373f1c083ab00a91431e5a489d4f1cbf5fab2ffe30af7195ef68-removebg-preview.png"
                                        width="80" alt=""></a>
                                <a><img src="images/checkout/dark_gpay.svg" width="50" alt=""></a>
                            </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between"
                                    ...
                                    <div class="imgaes d-flex align-items-center justify-content-between">
                                        <div class=""
                                            ...
                                            <img src="images/checkout/visa.sxIq5Dot.svg" alt="">
                                        </div>

                                        <div class=""
                                            style="background-color: #fff; width: 38px; height: 24px;margin: 5px;">
                                            <img src="images/checkout/mastercard.1c4_lyMp.svg." alt="">
                                        </div>

                                        <div class=""
                                            style="background-color: #fff; width: 38px; height: 24px;margin: 5px;">
                                            <img src="images/checkout/amex.Csr7hRoy.svg" alt="">
                                        </div>

                                        <div class=""
                                            style="background-color: #fff; width: 38px; height: 24px;margin: 5px;">
                                            <img src="images/checkout/eftpos_au.eRlNmjwE.svg" alt="">
                                        </div>
                            ...
                            <div class="d-flex align-items-center justify-content-between mt-2">
                                ...
                                <img src="images/shop.jpg" width="40" height="25" style="opacity: .5;" alt="">
                    ...
                    <div class="col-12 col-sm-12 col-lg-5 col-paddingE bg-gray" style="">
                        <div class="" style="">
                            <div class="item d-flex justify-content-between align-items-center mb-2" style="padding: 10px;padding-left: 0;">
                                <div class="d-flex align-items-center">
                                    <div class="" style="position: relative;">
                                        <img src="images/checkout/beno-maternity-pillow-866749_64x64.jpg" width="64" height="64" style="border-radius: 4px;border: 1px solid #b8b8b8;" alt="">
                                        <span style="position: absolute;top: -10px;right: -10px; border-radius: 50%;background-color: gray; color: white;text-align: center; line-height: 20px;width: 20px;height: 20px;font-weight: 600;">1</span>
                                    </div>
                                    <div class="" style="padding-left: 20px;">
                                        <h3 style="font-size: 15px;font-weight: 400;">Mini Knee Pillow</h3>
                                    </div>
                                </div>

                                <div class="">
                                    <del style="font-size: 12px;color: #666;">USD 300.00$</del>
                                    <h4 style="font-weight: 400;">USD 199.00$</h4>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items" style="margin-bottom: 10px; font-size: 16px;">
                                ...
                                <span id="subtotalPrice">USD 199.00</span>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items" style="margin-bottom: 10px; font-size: 16px;">
                                <h4>Total</h4>
                                <h4 id="totalPrice">USD 199.00</h4>
                            </div>
    ...
    <script src="js/index.lnCcFIPd.js" crossorigin defer
        type="module"></script> -->
        <link rel="stylesheet" href="css/app.whj6cDzT.css" crossorigin />
        <link rel="stylesheet" href="css/OnePage.BL1uXB7_.css" crossorigin />
        <link rel="stylesheet" href="css/DeliveryMethodSelectorSection.DNerkzQV.css" crossorigin />
        <link rel="stylesheet" href="css/Rollup.o9Mx-fKL.css" crossorigin />
        <link rel="stylesheet" href="css/SubscriptionPriceBreakdown.Bqs0s4oM.css" crossorigin />
        <link rel="stylesheet" href="css/ShopPayLogo.D_HPU8Dh.css" crossorigin />
        <link rel="stylesheet" href="css/PickupPointCarrierLogo.C0wRU6wV.css" crossorigin />
        <link rel="stylesheet" href="css/VaultedPayment.BO3829nT.css" crossorigin />
        <link rel="stylesheet" href="css/Section.sQehCocD.css" crossorigin />
        <link rel="stylesheet" href="css/ShopPayLoginLoader.CjGSo8kt.css" crossorigin />
        <link rel="stylesheet" href="css/PayButtonSection.DF7trkKf.css" crossorigin />
        <link rel="stylesheet" href="css/RageClickCapture.DnkQ4tsk.css" crossorigin />
        <link rel="stylesheet" href="css/DutyOptions.Bd1Z60K2.css" crossorigin />
        <link rel="stylesheet" href="css/useAmazonContact.D-Ox6Dnf.css" crossorigin />
        <link rel="stylesheet" href="css/StockProblemsLineItemList.CxdIQKjw.css" crossorigin />
        <link rel="stylesheet" href="css/ShopPayVerificationSwitch.DVQdwG9J.css" crossorigin />
